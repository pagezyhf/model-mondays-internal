...
This repository automates the creation of Model Mondays blog posts - a weekly series highlighting trending Hugging Face models available in Microsoft Foundry.
...
| Date | Model | Parameters | Primary Task |
|------|-------|------------|--------------|
| Feb 2, 2026 | [zai-org/GLM-4.7-Flash](https://huggingface.co/zai-org/GLM-4.7-Flash) | 30B (3B active) | Agentic, Reasoning, Coding |
| Feb 2, 2026 | [facebook/sam3](https://huggingface.co/facebook/sam3) | 0.9B | Mask Generation, Segmentation |
| Feb 2, 2026 | [MiniMaxAI/MiniMax-M2.1](https://huggingface.co/MiniMaxAI/MiniMax-M2.1) | 229B (10B active) | Agentic, Coding |
| Feb 9, 2026 | [Qwen/Qwen3-Coder-Next](https://huggingface.co/Qwen/Qwen3-Coder-Next) | 80B (3B active) | Coding Agents, Tool Use |
| Feb 9, 2026 | [Qwen/Qwen3-ASR-1.7B](https://huggingface.co/Qwen/Qwen3-ASR-1.7B) | 1.7B | Speech Recognition (Multilingual) |
| Feb 9, 2026 | [Tongyi-MAI/Z-Image](https://huggingface.co/Tongyi-MAI/Z-Image) | 6B | Text-to-Image Generation |
